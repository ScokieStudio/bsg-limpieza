...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "BSG Limpieza es una empresa dedicada a brindar servicios de limpieza profesional e integral para empresas." },
      { name: "author", content: "BSG Limpieza" },
      { property: "og:title", content: "Limpieza Profesional e integral para tu empresa" },
      { property: "og:description", content: "BSG Limpieza es una empresa dedicada a brindar servicios de limpieza profesional e integral para empresas." },
      { property: "og:type", content: "website" },
      { name: "twitter:card", content: "summary" },
      { name: "twitter:site", content: "@bsg_limpieza" },
      { name: "twitter:title", content: "Limpieza Profesional e integral para tu empresa" },
      { name: "twitter:description", content: "BSG Limpieza es una empresa dedicada a brindar servicios de limpieza profesional e integral para empresas." },
